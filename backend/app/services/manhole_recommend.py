...
# ---------------------------------------------------------------------------
# Same-manhole-only pipe spec suggestion, used by the AI explanation for a
# bad/borderline manhole_status finding (app.api.v1.ai._manhole_pipe_suggestion_facts).
# ---------------------------------------------------------------------------
