...
class PipeRouteOut(BaseModel):
    ...
    # existed and it instead follows the concrete road network, or "bridge"
    # when neither graph spanned the gap — never left ambiguous which one
    # grounds a given line.
