...
Operational roles (Commissioner, AEE, AE and MLA) coexist with the existing
Admin and Architect collaboration roles. The enum is stored as VARCHAR
(`native_enum=False`); database initialization also upgrades older PostgreSQL
enum installations without removing existing users.
"""
...
class UserRole(str, enum.Enum):
    ...
    MLA = "mla"  # Read-only elected representative
    ADMIN = "admin"
    ARCHITECT = "architect"
